    ...
    return (
        <div clsss="container">
            ...
            <div className="bu-holder">
                     <button className="cta-left" href="https://www.who.int/ar/emergencies/diseases/novel-coronavirus-2019/advice-for-public">Learn More</button>
            ...
            <img className="small-virus" src={smallvirus} />
            <img className="small-virus2" src={smallvirus} />
            <img src={virus} />
